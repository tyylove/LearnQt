...
void AeaQt::KeyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (KeyButton::*_t)(int , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyButton::pressed)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject AeaQt::KeyButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_AeaQt__KeyButton.data,
      qt_meta_data_AeaQt__KeyButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
