...
void AeaQt::ChineseWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ChineseWidget *_t = static_cast<ChineseWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ChineseWidget::*_t)(const int & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChineseWidget::pressedChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject AeaQt::ChineseWidget::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_AeaQt__ChineseWidget.data,
      qt_meta_data_AeaQt__ChineseWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AeaQt::ChineseWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AeaQt__ChineseWidget.stringdata0))
        return static_cast<void*>(const_cast< ChineseWidget*>(this));
...
const QMetaObject AeaQt::Keyboard::staticMetaObject = {
    { &AbstractKeyboard::staticMetaObject, qt_meta_stringdata_AeaQt__Keyboard.data,
      qt_meta_data_AeaQt__Keyboard,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
